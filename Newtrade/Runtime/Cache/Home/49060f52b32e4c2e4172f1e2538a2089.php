                    ...
                    <div class="dashboard-page-main">
                        <div class="account-header">
                            <div class="acc-header-title">
                                <h2 class="heading">User Panel</h2>
                            </div>
                            <div class="acc-header-info-menu">
                                <ul class="info-menu">
                                    <li>
                                        <button class="btn btn-default btn-xs" style="font-size: 13px;" type="button">
                                            <a href="mailto:SpaceFinEX@gmail.com">Contact Us</a>
                                        </button>
                                    </li>
                                    <li><a href="#"><span class="flaticon-fullscreen"></span></a></li>
                                    <li class="author-avater"><a href="#"><img src="/Public/Home/fe/static/picture/btc.png"
                                                                               alt="Avater"></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="account-user-info">
                            <div class="single-user-info">
                                <h3 class="title"><?php echo ($user["username"]); ?></h3>
                                <p>Email Address</p>
                            </div>
                            <div class="single-user-info">
                                <h3 class="title"><?php echo (date("Y-m-d H:i:s",$user["reg_time"])); ?></h3>
                                <p>Registration Date</p>
                            </div>
                            <div class="single-user-info">
                                <h3 class="title"><?php echo (date("Y-m-d H:i:s",$log["add_time"])); ?></h3>
                                <p>Last Access</p>
                            </div>
                        </div>

                        <div class="row pricing-table-list pd-t-50">
                            <div class="col-lg-6">
                                <div class="pricing-box pricing-green" data-animate="hg-fadeInUp">
                                    ...
                                    <div class="pricing-content">
                                        <ul class="list">
                                            <li><?php echo ($currency['USDT']['num']); ?></li>
                                            <li class="text-muted h6">≈
                                                <span class="li_Subusdt" data-quantity="<?php echo ($currency['USDT']['usdt_num']); ?>"><?php echo ($currency['USDT']['usdt_num']); ?>usdt</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="pricing-box pricing-green" data-animate="hg-fadeInUp">
                                    ...
                                    <div class="pricing-content">
                                        <ul class="list">
                                            ...
                                            <li class="text-muted h6">≈
                                                <span class="li_Subbtc" data-quantity="<?php echo ($currency['BTC']['usdt_num']); ?>"><?php echo ($currency['BTC']['usdt_num']); ?>usdt</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="pricing-footer text-center">
                                ...
                                <div class="pricing-box pricing-green" data-animate="hg-fadeInUp">
                                    ...
                                    <div class="pricing-content">
                                        <ul class="list">
                                            ...
                                            <li class="text-muted h6">≈
                                                <span class="li_Subeth" data-quantity="<?php echo ($currency['ETH']['usdt_num']); ?>"><?php echo ($currency['ETH']['usdt_num']); ?>usdt</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="pricing-footer text-center">
                                ...
                                <div class="pricing-box pricing-green" data-animate="hg-fadeInUp">
                                    ...
                                    <div class="pricing-content">
                                        <ul class="list">
                                            ...
                                            <li class="text-muted h6">≈<span class="li_Subbdv"
                                                data-quantity="<?php echo ($currency['FEC']['usdt_num']); ?>"><?php echo ($currency['FEC']['usdt_num']); ?>usdt</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="pricing-footer text-center">
                ...
                <div class="col-lg-3">
                    <div class="dashboard-menu-area md-mrb-60">
                        <ul class="dashboard-menu">
                            <li><a href="./index">User Panel</a></li>
