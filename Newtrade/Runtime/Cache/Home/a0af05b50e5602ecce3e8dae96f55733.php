                    ...
                    <div class="page-header-content text-center">
                        ...
                        <div class="breadcrumb-area">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo U('UserCenter/myChain');?>">User Panel</a></li>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <th><?php echo ($vo["currencyName"]); ?></th>
                                            <th><?php echo ($vo["num"]); ?></th>
                                            <th class="text-right">
                                                <?php if($vo["check_time"] == 0): ?>-
                                                    <?php else: echo (date("Y-m-d H:i:s",$vo["check_time"])); endif; ?>
                                            </th>
