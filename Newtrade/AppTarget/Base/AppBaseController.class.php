...
class AppBaseController extends Controller{
    ...
    private function _getTokenInfo(){
        ...
        if(!empty($info['phone_imei'])) $this->_phone_imei = $info['phone_imei'];
        ...
        if($this->userId and $this->_os <> 'api_interface'){
            ...
            $input_data['time'] = $info['time'];
            $input_data['phone_imei'] = $this->_phone_imei;
