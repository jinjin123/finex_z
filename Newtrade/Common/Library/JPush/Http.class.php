<?php
namespace Common\Library\JPush;
use Common\Library\JPush\Exceptions\APIConnectionException;
use Common\Library\JPush\Exceptions\APIRequestException;
use Think\Exception;
...
final class Http {
    ...
    public static function processResp($response) {
        if($response['http_code'] === 200) {
            ...
            throw new Exceptions\APIRequestException($response);
        }
    }
