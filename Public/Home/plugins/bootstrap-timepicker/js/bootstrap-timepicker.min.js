!function ($, t, i) {
    "use strict";
    var e = function (t, i) {
        this.widget = "", this.$element = $(t), this.defaultTime = i.defaultTime, this.disableFocus = i.disableFocus, this.disableMousewheel = i.disableMousewheel, this.isOpen = i.isOpen, this.minuteStep = i.minuteStep, this.modalBackdrop = i.modalBackdrop, this.orientation = i.orientation, this.secondStep = i.secondStep, this.snapToStep = i.snapToStep, this.showInputs = i.showInputs, this.showMeridian = i.showMeridian, this.showSeconds = i.showSeconds, this.template = i.template, this.appendWidgetTo = i.appendWidgetTo, this.showWidgetOnAddonClick = i.showWidgetOnAddonClick, this.icons = i.icons, this.maxHours = i.maxHours, this.explicitMode = i.explicitMode, this.handleDocumentClick = function (t) {
            var i = t.data.scope;
    ...
    e.prototype = {
        constructor: e, _init: function () {
            var t = this;
            this.showWidgetOnAddonClick && this.$element.parent().hasClass("input-group") && this.$element.parent().hasClass("bootstrap-timepicker") ? (this.$element.parent(".input-group.bootstrap-timepicker").find(".input-group-addon").on({"click.timepicker": $.proxy(this.showWidget, this)}), this.$element.on({
                ...
                "blur.timepicker": $.proxy(this.blurElement, this),
                "mousewheel.timepicker DOMMouseScroll.timepicker": $.proxy(this.mousewheel, this)
            }), this.template !== !1 ? this.$widget = $(this.getTemplate()).on("click", $.proxy(this.widgetClick, this)) : this.$widget = !1, this.showInputs && this.$widget !== !1 && this.$widget.find("input").each(function () {
                $(this).on({
                    "click.timepicker": function () {
                        $(this).select()
                    }, "keydown.timepicker": $.proxy(t.widgetKeydown, t), "keyup.timepicker": $.proxy(t.widgetKeyup, t)
                })
            ...
            if (i.selection) {
                t.focus();
                var e = i.selection.createRange(), s = i.selection.createRange().text.length;
            ...
            }), "modal" === this.template && this.$widget.modal ? this.$widget.modal("hide") : this.$widget.removeClass("open"), $(i).off("mousedown.timepicker, touchend.timepicker", this.handleDocumentClick), this.isOpen = !1, this.$widget.detach())
            ...
            if (!this.disableMousewheel) {
                ...
                var i = t.originalEvent.wheelDelta || -t.originalEvent.detail, e = null;
                switch ("mousewheel" === t.type ? e = -1 * t.originalEvent.wheelDelta : "DOMMouseScroll" === t.type && (e = 40 * t.originalEvent.detail), e && (t.preventDefault(), $(this).scrollTop(e + $(this).scrollTop())), this.highlightedUnit) {
                    case"minute":
            ...
            if (!this.isInline) {
                var i = this.$widget.outerWidth(), e = this.$widget.outerHeight(), s = 10, h = $(t).width(),
                    n = $(t).height(), o = $(t).scrollTop(), a = parseInt(this.$element.parents().filter(function () {
                    ...
                    c = this.component ? this.component.outerWidth(!0) : this.$element.outerWidth(!1), l = r.left,
                    u = r.top;
                this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left"), "auto" !== this.orientation.x ? (this.$widget.addClass("timepicker-orient-" + this.orientation.x), "right" === this.orientation.x && (l -= i - c)) : (this.$widget.addClass("timepicker-orient-left"), r.left < 0 ? l -= r.left - s : r.left + i > h && (l = h - i - s));
                var p = this.orientation.y, m, g;
                "auto" === p && (m = -o + r.top - e, g = o + n - (r.top + d + e), p = Math.max(m, g) === g ? "top" : "bottom"), this.$widget.addClass("timepicker-orient-" + p), "top" === p ? u += d : u -= e + parseInt(this.$widget.css("padding-top"), 10), this.$widget.css({
                    top: u,
                    left: l,
                    zIndex: a
                })
            ...
            this.isOpen || this.$element.is(":disabled") || (this.$widget.appendTo(this.appendWidgetTo), $(i).on("mousedown.timepicker, touchend.timepicker", {scope: this}, this.handleDocumentClick), this.$element.trigger({
            ...
            }), this.place(), this.disableFocus && this.$element.blur(), "" === this.hour && (this.defaultTime ? this.setDefaultTime(this.defaultTime) : this.setTime("0:0:0")), "modal" === this.template && this.$widget.modal ? this.$widget.modal("show").on("hidden", $.proxy(this.hideWidget, this)) : this.isOpen === !1 && this.$widget.addClass("open"), this.isOpen = !0)
            ...
            var i = $(t.target), e = i.closest("a").data("action");
            e && this[e](), this.update(), i.is("input") && i.get(0).setSelectionRange(0, 2)
        }, widgetKeydown: function (t) {
            var i = $(t.target), e = i.attr("class").replace("bootstrap-timepicker-", "");
            switch (t.which) {
                case 9:
                    if (t.shiftKey) {
                        if ("hour" === e) return this.hideWidget()
                    } else if (this.showMeridian && "meridian" === e || this.showSeconds && "second" === e || !this.showMeridian && !this.showSeconds && "minute" === e) return this.hideWidget();
                    break;
                case 27:
                    this.hideWidget();
                    break;
        ...
        return i.shift(), this.each(function () {
            var s = $(this), h = s.data("timepicker"), n = "object" == typeof t && t;
            h || s.data("timepicker", h = new e(this, $.extend({}, $.fn.timepicker.defaults, n, $(this).data()))), "string" == typeof t && h[t].apply(h, i)
        })
        ...
        maxHours: 24,
        explicitMode: !1
    }, $.fn.timepicker.Constructor = e, $(i).on("focus.timepicker.data-api click.timepicker.data-api", '[data-provide="timepicker"]', function (t) {
        var i = $(this);
        i.data("timepicker") || (t.preventDefault(), i.timepicker())
    })
